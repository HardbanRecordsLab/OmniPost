 ...
 import { LayoutDashboard, Calendar, List, Sparkles, BarChart3, Settings, ChevronLeft, ChevronRight, HelpCircle, Crown, Network, PenTool, Image, Link } from "lucide-react"
...
const navItems: NavItem[] = [
  ...
  { icon: Link, label: "Link Manager", id: "link-manager" },
     ...
     <TooltipProvider delayDuration={0}>
       <motion.aside initial={false} animate={{ width: isCollapsed ? 80 : 280 }} transition={{ type: "spring", stiffness: 300, damping: 30 }} className="relative h-screen bg-sidebar border-r border-sidebar-border flex flex-col">
         <div className="p-4 flex items-center gap-3 border-b border-sidebar-border">
          <motion.div whileHover={{ rotate: 180 }} transition={{ duration: 0.5 }} className="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 overflow-hidden">
            <img 
